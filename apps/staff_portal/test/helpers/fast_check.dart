/// Minimal property-based testing helper for apps/staff_portal tests.
///
/// Mirrors the pattern in packages/api_client/test/helpers/fast_check.dart.
/// Provides [Arbitrary] generators and the [forAll] / [forAllAsync] runners.
library fast_check;
...
///
/// Throws on the first failing iteration.
void forAll<T>(
